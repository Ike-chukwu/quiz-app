...
const CourseCard = ({ dispatch, courseImg, courseName }: Props) => {
  return (
    <div
      ...
      className="w-full cursor-pointer transition-all ease-in duration-75 hover:border-1 hover:border-white lg:w-[400px] px-3 py-3 md:py-5 bg-[#3B4D66] rounded-[20px] flex items-center gap-3 md:gap-6"
    >
